...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
	switch (section) {
		...
		case 1 : return @"Médecine";break;
		case 2 : return @"Animaux";break;
		case 3 : return @"Taxis";break;
		case 4 : return @"Divers";break;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch (indexPath.section) {
		...
		case 1: switch (indexPath.row) {
			...
			case 4 : cell.textLabel.text = @"SOS Médecins à domicile 24h/24";cell.detailTextLabel.text=@"0227484950";break;
			case 5 : cell.textLabel.text = @"Genève-Médecins 24h/24";cell.detailTextLabel.text=@"0227545454";break;
			case 6 : cell.textLabel.text = @"SOS Infirmières 24h/24";cell.detailTextLabel.text=@"0224202464";break;
			case 7 : cell.textLabel.text = @"STOP-Suicide 24h/24";cell.detailTextLabel.text=@"0223824242";break;
			case 8 : cell.textLabel.text = @"Clinique des Grangettes 7h-23h";cell.detailTextLabel.text=@"0223050777";break;
			case 9 : cell.textLabel.text = @"Permanence de Cornavin";cell.detailTextLabel.text=@"0223454550";break;
			case 10 : cell.textLabel.text = @"Groupe médical d'Onex 24h/24";cell.detailTextLabel.text=@"0228795050";break;
			case 11: cell.textLabel.text = @"Policlinique chirurgie et médecine";cell.detailTextLabel.text=@"0223726408";break;
			case 12: cell.textLabel.text = @"Centre Médical du Léman";cell.detailTextLabel.text=@"0227160660";break;
			case 13: cell.textLabel.text = @"Association des chiropraticiens";cell.detailTextLabel.text=@"0227818200";break;
			case 14: cell.textLabel.text = @"Association des Médecins-dentistes";cell.detailTextLabel.text=@"111";break;
			default: cell.textLabel.text = @"default";break;
		}; break;
